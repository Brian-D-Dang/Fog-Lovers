...
st.write('Cloud water interception (CWI) is the process by which water droplets within clouds, carried by winds, are captured and deposited onto vegetation and other encountered obstacles. This accumulated water then drips to the ground, supplementing rainfall and contributing to overall water availability. Thus, fog is a crucial water resource on mountainous islands such as the Hawaiian Islands, where it has been studied for over 70 years (DeLay and Giambelluca, 2011). However, there are practical challenges to measuring fog’s contribution to the water balance.')
st.image(os.path.join('media', 'CWI-Han-Tseng-1-1024x765.png'), use_column_width=True)


st.write('Traditionally fog has been measured using mechanical collectors, sometimes referred to as fog gauges, as well as canopy water balance measurements. See image of fog catchment device below.')
st.image(os.path.join('media', 'Kahikinui Fog Screens.jpg'), use_column_width=True)

st.write('There are some short comings to these traditional techniques. Such as contamination with wind-blow rain and their equitment footprint. Trail Camers offer a low-cost method to observe fog presence. Train cameras can be used to augment traditional equitment installations providing increased spatial coverage.')
...
st.image(os.path.join('media', 'IMG_0635.JPG'), use_column_width=True)
